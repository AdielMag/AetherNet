...
public static class MathExtensions
{
    ...
    public static SNV2 ToSimulation(in SNV2 worldPos) => worldPos / SimulationConstants.PixelsPerMeter;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SNV2 ToWorld(in SNV2 simPos) => simPos * SimulationConstants.PixelsPerMeter;
